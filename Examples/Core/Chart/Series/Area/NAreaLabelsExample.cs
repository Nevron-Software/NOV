...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// </summary>
	public class NAreaLabelsExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NAreaLabelsExampleSchema = NSchema.Create(typeof(NAreaLabelsExample), NChartExampleBase.NChartExampleBaseSchema);
		}

...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// Line Labels Example
	/// </summary>
	public class NLineLabelsExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NLineLabelsExampleSchema = NSchema.Create(typeof(NLineLabelsExample), NChartExampleBase.NChartExampleBaseSchema);
		}

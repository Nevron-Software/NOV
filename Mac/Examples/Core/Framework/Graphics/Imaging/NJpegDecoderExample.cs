...
{
	public class NJpegDecoderExample : NExampleBase
	{
		#region Constructors

		public NJpegDecoderExample()
		{
		}
		static NJpegDecoderExample()
		{
			NJpegDecoderExampleSchema = NSchema.Create(typeof(NJpegDecoderExample), NExampleBase.NExampleBaseSchema);
		}
...
";
		...
		public static readonly NSchema NJpegDecoderExampleSchema;

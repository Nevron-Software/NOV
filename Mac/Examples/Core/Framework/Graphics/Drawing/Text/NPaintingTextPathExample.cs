...
{
	/// <summary>
	/// The example demonstrates how to paint text path bounds
	/// </summary>
	public class NPaintingTextPathExample : NExampleBase
	{
		#region Constructors
		...
		/// Default constructor.
		/// </summary>
		public NPaintingTextPathExample()
		{
		}
		/// <summary>
		/// Static constructor.
		/// </summary>
		static NPaintingTextPathExample()
		{
			NPaintingTextPathExampleSchema = NSchema.Create(typeof(NPaintingTextPathExample), NExampleBase.NExampleBaseSchema);
		}
		...
		protected override string GetExampleDescription()
		{
			return @"
<p>
The example demonstrates how to paint text at bounds. Use the controls to the right to modify different parameters of the rectangular paint text settings.
</p>
";
		}
		...
		/// <summary>
		/// Schema associated with NPaintingTextPathExample.
		/// </summary>
		public static readonly NSchema NPaintingTextPathExampleSchema;

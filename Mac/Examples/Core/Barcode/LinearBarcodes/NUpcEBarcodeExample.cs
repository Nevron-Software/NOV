...
{
	public class NUpcEBarcodeExample : NExampleBase
	{
		#region Constructors
		...
		/// Static constructor.
		/// </summary>
		static NUpcEBarcodeExample()
		{
			NUpcEBarcodeExampleSchema = NSchema.Create(typeof(NUpcEBarcodeExample), NExampleBase.NExampleBaseSchema);
		}
		...
		protected override NWidget CreateExampleContent()
		{
			...
			m_Barcode.Symbology = ENLinearBarcodeSymbology.UPCE;
			m_Barcode.Text = "654321";
		...
		protected override string GetExampleDescription()
		{
			return @"
<p>
	This example demonstrates how to create an UPC-E barcode. Use the controls on the right to change
...
";
		...
		/// <summary>
		/// Schema associated with NUpcEBarcodeExample.
		/// </summary>
		public static readonly NSchema NUpcEBarcodeExampleSchema;

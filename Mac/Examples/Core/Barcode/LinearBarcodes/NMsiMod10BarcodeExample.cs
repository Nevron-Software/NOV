...
{
	public class NMsiMod10BarcodeExample : NExampleBase
	{
		#region Constructors
		...
		/// Default constructor.
		/// </summary>
		public NMsiMod10BarcodeExample()
		{
		}
		...
		/// Static constructor.
		/// </summary>
		static NMsiMod10BarcodeExample()
		{
			NMsiMod10BarcodeExampleSchema = NSchema.Create(typeof(NMsiMod10BarcodeExample), NExampleBase.NExampleBaseSchema);
		}
		...
		protected override NWidget CreateExampleContent()
		{
			...
			m_Barcode.Symbology = ENLinearBarcodeSymbology.MSI_Mod10;
			m_Barcode.Text = "1234567";
		...
		protected override string GetExampleDescription()
		{
			return @"
<p>
	This example demonstrates how to create an MSI Mod 10 barcode. Use the controls on the right to change
...
";
		...
		/// <summary>
		/// Schema associated with NMsiMod10BarcodeExample.
		/// </summary>
		public static readonly NSchema NMsiMod10BarcodeExampleSchema;

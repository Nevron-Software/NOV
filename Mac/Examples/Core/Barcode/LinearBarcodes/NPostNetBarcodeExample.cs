...
{
	public class NPostNetBarcodeExample : NExampleBase
	{
		#region Constructors
		...
		/// Static constructor.
		/// </summary>
		static NPostNetBarcodeExample()
		{
			NPostNetBarcodeExampleSchema = NSchema.Create(typeof(NPostNetBarcodeExample), NExampleBase.NExampleBaseSchema);
		}
		...
		protected override NWidget CreateExampleContent()
		{
			...
			m_Barcode.Symbology = ENLinearBarcodeSymbology.PostNet;
			m_Barcode.Text = "555551237";
		...
		protected override string GetExampleDescription()
		{
			return @"
<p>
	This example demonstrates how to create a POSTNET (<b>Post</b>al <b>N</b>umeric <b>E</b>ncoding
	<b>T</b>echnique) barcode. Use the controls on the right to change the appearance of the barcode widget.
</p>
";
		}
		...
		/// <summary>
		/// Schema associated with NPostNetBarcodeExample.
		/// </summary>
		public static readonly NSchema NPostNetBarcodeExampleSchema;

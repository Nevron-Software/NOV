...
{
	public class NStandard2of5BarcodeExample : NExampleBase
	{
		#region Constructors
		...
		/// Default constructor.
		/// </summary>
		public NStandard2of5BarcodeExample()
		{
		}
		...
		/// Static constructor.
		/// </summary>
		static NStandard2of5BarcodeExample()
		{
			NStandard2of5BarcodeExampleSchema = NSchema.Create(typeof(NStandard2of5BarcodeExample), NExampleBase.NExampleBaseSchema);
		}
		...
		protected override NWidget CreateExampleContent()
		{
			...
			m_Barcode.Symbology = ENLinearBarcodeSymbology.Standard2of5;
		...
		protected override string GetExampleDescription()
		{
			return @"
<p>
	This example demonstrates how to create a Standard 2 of 5 barcode. Use the controls on the right to change
...
";
		...
		/// <summary>
		/// Schema associated with NStandard2of5BarcodeExample.
		/// </summary>
		public static readonly NSchema NStandard2of5BarcodeExampleSchema;

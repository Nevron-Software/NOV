...
{
	public class NOccurrencesModificationExample : NScheduleExampleBase
	{
		#region Constructors
		...
		{
			NOccurrencesModificationExampleSchema = NSchema.Create(typeof(NOccurrencesModificationExample), NScheduleExampleBase.NScheduleExampleBaseSchema);
		}

...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// </summary>
	public class NStackedLineExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NStackedLineExampleSchema = NSchema.Create(typeof(NStackedLineExample), NChartExampleBase.NChartExampleBaseSchema);
		}

...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// Stick Stock Example
	/// </summary>
	public class NStickStockExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NStickStockExampleSchema = NSchema.Create(typeof(NStickStockExample), NChartExampleBase.NChartExampleBaseSchema);
		}

...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// Polar area example
	/// </summary>
	public class NPolarLineExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NPolarLineExampleSchema = NSchema.Create(typeof(NPolarLineExample), NChartExampleBase.NChartExampleBaseSchema);
		}

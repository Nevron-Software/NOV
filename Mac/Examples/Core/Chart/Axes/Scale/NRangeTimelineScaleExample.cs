...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// </summary>
	public class NRangeTimelineScaleExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NRangeTimelineScaleExampleSchema = NSchema.Create(typeof(NRangeTimelineScaleExample), NChartExampleBase.NChartExampleBaseSchema);
		}

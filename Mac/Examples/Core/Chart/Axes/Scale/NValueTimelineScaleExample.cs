...
namespace Nevron.Nov.Examples.Chart
{
	...
	public class NValueTimelineScaleExample : NChartExampleBase
	{
		...
		/// Default constructor
		/// </summary>
		public NValueTimelineScaleExample()
		{
		...
		{
			m_TimeLineScale.FirstRow.Visible = ((NCheckBox)arg.TargetNode).Checked;
		}

		void OnSecondRowVisibleCheckBoxClick(NEventArgs arg)
		{
			m_TimeLineScale.SecondRow.Visible = ((NCheckBox)arg.TargetNode).Checked;
		}

		void OnFirstRowVisibleCheckBoxClick(NEventArgs arg)
		{
			m_TimeLineScale.ThirdRow.Visible = ((NCheckBox)arg.TargetNode).Checked;
		}
		...
		NValueTimelineScale m_TimeLineScale;

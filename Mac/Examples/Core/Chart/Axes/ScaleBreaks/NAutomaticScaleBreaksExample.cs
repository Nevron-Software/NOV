...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// </summary>
	public class NAutomaticScaleBreaksExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NAutomaticScaleBreaksExampleSchema = NSchema.Create(typeof(NAutomaticScaleBreaksExample), NChartExampleBase.NChartExampleBaseSchema);
		}

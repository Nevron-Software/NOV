...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// </summary>
	public class NAxisStripsExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NAxisStripsExampleSchema = NSchema.Create(typeof(NAxisStripsExample), NChartExampleBase.NChartExampleBaseSchema);
		}

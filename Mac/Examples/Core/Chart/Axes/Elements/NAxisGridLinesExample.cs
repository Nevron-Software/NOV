...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// </summary>
	public class NAxisGridLinesExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NAxisGridLinesExampleSchema = NSchema.Create(typeof(NAxisGridLinesExample), NChartExampleBase.NChartExampleBaseSchema);
		}

...
{
	public class NBrainstormingShapesExample : NDiagramExampleBase
	{
		#region Constructors
		...
		{
			NBrainstormingShapesExampleSchema = NSchema.Create(typeof(NBrainstormingShapesExample), NDiagramExampleBase.NDiagramExampleBaseSchema);
		}
		...
		protected override string GetExampleDescription()
		{
			return @"
<p>
    This example demonstrates the brainstorming shapes, which are created by the NBrainstormingShapesFactory.
</p>
";
		}

...
{
	public class NAnnotationShapesExample : NDiagramExampleBase
	{
		#region Constructors
		...
		{
			NAnnotationShapesExampleSchema = NSchema.Create(typeof(NAnnotationShapesExample), NDiagramExampleBase.NDiagramExampleBaseSchema);
		}

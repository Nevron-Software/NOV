...
{
	public class NCode93BarcodeExample : NExampleBase
	{
		#region Constructors
		...
		/// Static constructor.
		/// </summary>
		static NCode93BarcodeExample()
		{
			NCode93BarcodeExampleSchema = NSchema.Create(typeof(NCode93BarcodeExample), NExampleBase.NExampleBaseSchema);
		}
		...
		protected override NWidget CreateExampleContent()
		{
			...
			m_Barcode.Symbology = ENLinearBarcodeSymbology.Code93;
		...
		protected override string GetExampleDescription()
		{
			return @"
<p>
	This example demonstrates how to create a Code 93 barcode. Use the controls on the right to change
...
";
		...
		/// <summary>
		/// Schema associated with NCode93BarcodeExample.
		/// </summary>
		public static readonly NSchema NCode93BarcodeExampleSchema;

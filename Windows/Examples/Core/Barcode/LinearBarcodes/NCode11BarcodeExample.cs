...
{
	public class NCode11BarcodeExample : NExampleBase
	{
		#region Constructors
		...
		/// Static constructor.
		/// </summary>
		static NCode11BarcodeExample()
		{
			NCode11BarcodeExampleSchema = NSchema.Create(typeof(NCode11BarcodeExample), NExampleBase.NExampleBaseSchema);
		}
...
";
		...
		/// </summary>
		public static readonly NSchema NCode11BarcodeExampleSchema;

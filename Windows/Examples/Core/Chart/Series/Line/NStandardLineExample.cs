...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// </summary>
	public class NStandardLineExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NStandardLineExampleSchema = NSchema.Create(typeof(NStandardLineExample), NChartExampleBase.NChartExampleBaseSchema);
		}

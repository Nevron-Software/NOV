...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// Bar Labels Example
	/// </summary>
	public class NBarLabelsExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NBarLabelsExampleSchema = NSchema.Create(typeof(NBarLabelsExample), NChartExampleBase.NChartExampleBaseSchema);
		}

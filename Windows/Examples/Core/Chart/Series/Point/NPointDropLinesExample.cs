...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// </summary>
	public class NPointDropLinesExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NPointDropLinesExampleSchema = NSchema.Create(typeof(NPointDropLinesExample), NChartExampleBase.NChartExampleBaseSchema);
		}

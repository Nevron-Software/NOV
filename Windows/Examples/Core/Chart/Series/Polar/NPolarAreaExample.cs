...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// Polar area example
	/// </summary>
	public class NPolarAreaExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NPolarAreaExampleSchema = NSchema.Create(typeof(NPolarAreaExample), NChartExampleBase.NChartExampleBaseSchema);
		}

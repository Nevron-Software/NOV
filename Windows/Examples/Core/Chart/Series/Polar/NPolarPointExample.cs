...
namespace Nevron.Nov.Examples.Chart
{
	...
	/// Polar point example
	/// </summary>
	public class NPolarPointExample : NChartExampleBase
	{
		#region Constructors
		...
		{
			NPolarPointExampleSchema = NSchema.Create(typeof(NPolarPointExample), NChartExampleBase.NChartExampleBaseSchema);
		}
